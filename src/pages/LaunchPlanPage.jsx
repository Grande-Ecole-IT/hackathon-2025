    ...
    <div className="container mx-auto px-4 md:px-6 py-12">
      ...
      <div className="flex flex-col items-center text-center mb-12">
        ...
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl mb-4">
          Votre Plan de Lancement
        </h1>
        <p className="text-xl text-gray-500 max-w-3xl">
          Une feuille de route personnalisée pour transformer votre idée en
          entreprise viable, avec des ressources et des étapes concrètes.
        </p>
      </div>
              ...
              {[
                ...
                <button
                  ...
                  className={`text-sm font-medium px-4 py-2 rounded-md transition-all ${
                    tab === t.value
                      ? "text-white shadow bg-gradient-to-r from-blue-500 to-violet-500"
            ...
            <div className="bg-white rounded-lg border p-6 space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Un calendrier prévisionnel pour le lancement de votre
                  entreprise, basé sur votre disponibilité et vos ressources.
                </p>
              </div>
              <div className="text-center py-12 text-gray-500">
                Veuillez d'abord compléter votre profil de disponibilité pour
                générer un calendrier personnalisé.
              </div>
              <div>
                <Link
                  to="/launch-plan/timeline"
                  className="inline-flex items-center justify-center w-full px-4 py-2 bg-gradient-to-r from-blue-500 to-violet-500 text-white font-medium rounded-md hover:bg-emerald-700 transition-colors"
                >
        ...
        <div>
          <div className="bg-white rounded-lg shadow border sticky top-8 p-6 space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Suivez l'avancement de votre projet entrepreneurial
              </p>
            </div>
            <div>
  ...
  return (
    <div className="rounded-2xl border bg-white shadow-sm p-4">
      <div className="mb-2 flex flex-row items-start">
        <div className="bg-purple-100 text-blue-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 flex-shrink-0 font-semibold">
          {number}
        </div>
        <div className="flex-1">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-xs font-medium px-2 py-0.5 rounded-full ${badgeClasses[status]}`}
            >
              {badgeText[status]}
            </span>
          </div>
