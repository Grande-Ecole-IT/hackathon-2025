const Button = ({ children, color = "light", className = "", ...props }) => {
  ...
  const colorClasses =
    color === "light"
      ...
      : `bg-gradient-to-r from-blue-500 to-violet-500 dark:bg-gray-300 text-white dark:text-gray-900 dark:border-gray-400 active:text-gray-300 dark:active:text-gray-700`;
